...
import (
	...
	api_v1 "github.com/currycan/ops-exporter/api/v1"
	"github.com/currycan/ops-exporter/asset"
	"github.com/currycan/ops-exporter/handler"
	"github.com/currycan/ops-exporter/storage"
)
...
func main() {
	...
	app.Version(version.Print("ops-exporter"))
	...
	*routePrefix = computeRoutePrefix(*routePrefix, *externalURL)
	...
	level.Info(logger).Log("msg", "starting ops-exporter", "version", version.Info())
