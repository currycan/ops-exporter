...
import (
	...
	"github.com/currycan/ops-exporter/testutil"
)
	...
	"data": [
		{
			...
			"push_failure_time_seconds": {
				"time_stamp": "2020-03-10T00:54:08.025744841+05:30",
				"type": "GAUGE",
				"help": "Last Unix time when changing this group in the ops-exporter failed.",
				"metrics": [
					{
						"labels": {
							"instance": "inst'a\"n\\ce1",
			...
			"push_time_seconds": {
				"time_stamp": "2020-03-10T00:54:08.025744841+05:30",
				"type": "GAUGE",
				"help": "Last Unix time when changing this group in the ops-exporter succeeded.",
				"metrics": [
					{
						"labels": {
							"instance": "inst'a\"n\\ce1",
